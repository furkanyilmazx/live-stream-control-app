      ...
      render() {
        ...
        return (
          <Layout style={{ minHeight: '100vh' }}>
            <Sider
            trigger={<Icon className="default-layout-trigger" type={!this.state.collapsed ? 'left' : 'right'} />}
              collapsible
            ...
            <Layout>
              ...
              <Content style={{ margin: '0 16px', height: '1200px' }}>
                ...
                <div style={{ padding: 24, background: '#fff', minHeight: 360 }}>
                  {
                      ...
                      <VideoPlayer key={index} { ...{ autoplay: true,
                        controls: true,
                        sources: [{
                          src: item.url,
                        }]} } />
